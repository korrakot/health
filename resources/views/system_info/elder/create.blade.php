...
<form method="post" action="{{ route('elder.store') }}">
  @csrf
  <div class="row">
    <div class="form-group col-sm-12">
      <label for="id" class="col-form-label">รหัสบัตรประจำตัวประชาชน :</label>
      <div>
      <input type="number" class="form-control" id="id" name="id" placeholder="เลขบัตรประจำตัวประชาชน 13 หลัก">
      </div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row">    
    ...
    <div class="form-group col-4">
      ...
      <div>
      <input type="number" class="form-control" id="weight" name="weight" placeholder="น้ำหนัก">
      </div>
    </div>
    <div class="form-group col-4">
      <label for="height" class="col-form-label">ส่วนสูง :</label>
      <div>
      <input type="number" class="form-control" id="height" name="height" placeholder="ส่วนสูง">
      </div>
    </div>
  </div>
  <div class="row">
    <div class="form-group col-12">
      ...
      <div>
        <textarea class="form-control" id="address" name="address" placeholder="รายละเอียด"s="3"></textarea>
      </div>
    </div>
  </div>
  <div class="row">
